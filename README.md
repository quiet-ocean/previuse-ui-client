...
Previuse marketer UI was bootstrapped with [Create React App](https://github.com/facebook/create-react-app).
...
build the project and serve the static files on port 3001
